...
model = dict(
    ...
    devoxel_neck=dict(
        ...
        in_channels=numC_Trans * 8 + numC_Trans * 2,
        out_channels=256),
    pre_process = dict(type='ResNetForBEVDet',numC_input=numC_Trans,#conv_cfg=dict(type='ShapeConv2d'),
    ...
    pts_bbox_head=dict(
        ...
        bbox_coder=dict(
            ...
            code_size=9),
        separate_head=dict(
            type='SeparateHead', #conv_cfg=dict(type='ShapeConv2d'), 
...
# work_dir = "/85069/hanchao/work_dir_flow/bevdepth4d-r101-A-10-1"
